...
from_trait!(FromU7(u7 u8) { impl for u8 u16 u32 u64 u128 usize i8 i16 i32 i64 i128 isize f32 f64 });
from_trait!(FromU8(u8 u8) { impl for u8 u16 u32 u64 u128 usize i16 i32 i64 i128 isize f32 f64 });
...
from_trait!(FromI8(i8 i8) { impl for i8 i16 i32 i64 i128 isize f32 f64 });
...
from_trait!(FromF32(f32 f32): FromU16 + FromI16 { impl for f32 f64 });
from_trait!(FromF64(f64 f64): FromU32 + FromI32 { impl for f64 });
